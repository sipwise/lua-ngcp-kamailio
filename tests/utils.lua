...
TestUtils = {}
    ...
    function TestUtils:test_explode_lnp()
        assertItemsEquals(utils.explode_lnp("123"), {'1','12','123'})
        assertItemsEquals(utils.explode_lnp("1"), {'1'})
        assertItemsEquals(utils.explode_lnp(""), {})
        assertError(utils.explode_lnp, nil)
    end
